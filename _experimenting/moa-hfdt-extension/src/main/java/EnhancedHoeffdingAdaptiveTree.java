 ...
 * @version $Revision: 7 $
 */
public class EnhancedHoeffdingAdaptiveTree extends EnhancedHoeffdingTree {

    private static final long serialVersionUID = 1L;

    EnhancedHoeffdingAdaptiveTree(PrintWriter fileWriter, Integer printLimit) {
        super(fileWriter, printLimit);
    }
    ...
    public interface NewNode {
        ...
        void learnFromInstance(Instance inst, HoeffdingAdaptiveTree ht, SplitNode parent, int parentBranch);
    ...
    public static class AdaSplitNode extends SplitNode implements NewNode {
        ...
        public void learnFromInstance(Instance inst, EnhancedHoeffdingTree ht, SplitNode parent, int parentBranch) {
        ...
        @Override
        public void killTreeChilds(EnhancedHoeffdingTree ht) {
            for (Node child : this.children) {
                if (child != null) {
